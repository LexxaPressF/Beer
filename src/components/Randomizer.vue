<template>
    <div id="random_bg" v-bind:style="{
            backgroundColor: 'rgba(94, 64, 34, 0.5)'}">>
        <div id="wrapper">
            <img id="picture" src="../assets/beer.png"/>
        ...
        <div id="randomizer" v-if="name !== ''">
            <Card v-for="item in Object.keys(beerInfo)" :key= "item"
    ...
    methods:{
        recommend(){
            this.axios.get("https://random-data-api.com/api/beer/random_beer")
                .then((response) =>{
                 this.beerInfo.name = response.data.name
                 this.beerInfo.brand = response.data.brand
                 this.beerInfo.style = response.data.style
                 this.beerInfo.malts = response.data.malts
                 this.beerInfo.alcohol = response.data.alcohol
                })
        }
    }
}
...
#random_bg{
    ...
    background-color: rgba(94, 64, 34, 0.9);
